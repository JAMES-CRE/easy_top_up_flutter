...
// Embedded inside the bottom sheet
// Shows star rating, average, all reviews, and add review button

class ReviewsSection extends StatefulWidget {
  final String stationId;

  const ReviewsSection({super.key, required this.stationId});
...
class _ReviewsSectionState extends State<ReviewsSection> {
              ...
              actions: [
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    // Save review
                    ReviewsStore.instance.addReview(
  ...
  Widget build(BuildContext context) {
    final reviews =
        ReviewsStore.instance.getReviews(widget.stationId);
    final avgRating =
        ReviewsStore.instance.getAverageRating(widget.stationId);
      ...
      children: [
              ...
              : Row(
                  children: [
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        _stars(avgRating.round(), size: 22),
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      _timeAgo(review['timestamp'] as DateTime),
                      style: const TextStyle(
                ...
                // Stars
                _stars(review['stars'] as int),

                // Comment — only show if not empty
        ...
        if (reviews.length > 3)
          Center(
            child: TextButton(
              onPressed: () {
                // TODO: show all reviews in a full screen
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Full reviews coming soon'),
                    behavior: SnackBarBehavior.floating,
                  ),
                );
              },
              ...
              content: Column(
                ...
                children: [
                  ...
                  Row(
                    children: List.generate(5, (index) {
                      return GestureDetector(
                        onTap: isSubmitting ? null : () => setDialogState(() => selectedStars = index + 1),
                        child: Icon(
        ...
        Row(
          ...
          children: [
            ...
            if (AuthState.instance.isLoggedIn)
              TextButton.icon(
                onPressed: _showAddReviewDialog,
                icon: const Icon(Icons.rate_review_outlined, size: 16, color: _brandGreen),
                label: const Text(
                  'Add Review',
                  style: TextStyle(color: _brandGreen, fontSize: 13, fontWeight: FontWeight.w600),
                ),
